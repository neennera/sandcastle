<script lang="ts">
  ...
  <div
    class="absolute z-0 top-[25%] mt-6 flex flex-col h-0 opacity-0 w-[85%] items-center justify-center rounded-[20px] bg-[#f3f5e7] border-[#e3d1a0] border-[2px] font-bold text-[#8D7878] text-[24px] sm:text-[36px]"
    id="friend-popup"
  >
